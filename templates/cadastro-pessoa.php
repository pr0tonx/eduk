...
<body class="main-container">
    ...
    <div class="flex-jc-c-ai-c">
        <form name="formCadPessoa" class="register-form" method="post" action="processa-cadastro.php?id=<?php echo $id?>" onsubmit="validarFormulario()">
            <div>
                <span>Bem vindo, <?php echo $email ?>, para concluir o seu cadastro, é essencial que preencha todas as informações a seguir: </span>
            </div>
            ...
            <div class="flex-jc-sb-ai-c">
                <div class="register-form-field flex">
                    ...
                    <input type="text" class="register-form-input" name="nome" id="nome" placeholder="Digite seu nome" required pattern="^[a-zA-Z]+(\s[a-zA-Z]+)+$">
                </div>

                <div class="register-form-field flex">
                    <label class="register-form-label" for="sobrenome">Sobrenome</label>
                    <input type="text" class="register-form-input" name="sobrenome" id="sobrenome" placeholder="Digite seu sobrenome" required pattern="^[a-zA-Z]+(\s[a-zA-Z]+)+$">
                </div>
            </div>
            ...
            <div class="flex-jc-sb-ai-c">
                <div class="register-form-field flex">
                    ...
                    <input class="register-form-input" type="text" name="cpf" id="cpf" placeholder="123.456.789-00" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" maxlength="14" required>
                </div>

                <div class="register-form-field flex">
                    <label class="register-form-label" for="rg">RG</label>
                    <input class="register-form-input" type="text" name="rg" id="rg" placeholder="12.345.678-9" maxlength="12" pattern="\d{2}\.\d{3}\.\d{3}-\d{1}" required>
                </div>
            </div>
            ...
            <div class="flex-jc-sb-ai-c">
                <div class="register-form-field flex">
                    ...
                    <input type="text" class="register-form-input" name="nacionalidade" id="nacionalidade" placeholder="BR" required>
                </div>

                <div class="register-form-field flex">
                    <label class="register-form-label" for="dataNascimento">Data de Nascimento</label>
                    <input class="register-form-input" name="dataNascimento" id="dataNascimento" placeholder="DD/MM/AAAA" maxlength="10" required>
                </div>
            </div>
            ...
            <div class="flex-jc-sb-ai-c">
                <div class="register-form-field flex">
                    ...
                    <input class="register-form-input" type="tel" name="telefone" id="telefone" placeholder="(99) 99999-9999" maxlength="15" required>
                </div>
            ...
            <div class="flex-jc-sb-ai-c">
                <div class="register-form-field flex">
                    ...
                    <input class="register-form-input" type="text" name="rua" id="rua" placeholder="Rua Flores Azuis" pattern="^[a-zA-Z]+(\s[a-zA-Z]+)+$" required>
                </div>

                <div class="register-form-field flex">
                    <label class="register-form-label" for="bairro">Bairro</label>
                    <input class="register-form-input" type="text" name="bairro" id="bairro" placeholder="Ex: Centro" required>
                </div>
            </div>
            ...
            <div class="flex-jc-sb-ai-c">
                ...
                <div class="register-form-field-two flex">
                    ...
                    <input class="register-form-input" type="text" name="complemento" id="complemento" placeholder="Apartamento 101">
                </div>

                <div class="register-form-field-two flex">
                    <label class="register-form-label" for="cep">CEP</label>
                    <input class="register-form-input" type="text" name="cep" id="cep" placeholder="12345-678" pattern="\d{5}-\d{3}" maxlength="9" required>
                </div>
            </div>
            ...
            <div class="flex-jc-sb-ai-c">
                <div class="register-form-field-two flex">
                    ...
                    <input class="register-form-input" type="text" name="cidade" id="cidade" placeholder="São Paulo" required>
                </div>
