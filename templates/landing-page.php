            ...
            <div class="modal-container hidden" id="modal-container">
                ...
                <div class="modal-container-inner">
                    ...
                    <div class="middle-one login-form" id="middle-one">
                        <input class="login-form__email" type="email" name="email" placeholder="Email" required>
            ...
            <div>
                <ul class="testimonial__cards">
                    <li class="testimonial__card">
                        <div>
                            <div class="flex-ai-c">
                                <img src="../assets/profile-1.png" width="44" height="44" alt="Foto de usuário relatando sua experiência na plataforma">
                    ...
                    <li class="testimonial__card">
                        <div>
                            <div class="flex-ai-c">
                                <img src="../assets/profile-2.png" width="44" height="44" alt="Foto de usuário relatando sua experiência na plataforma">
                    ...
                    <li class="testimonial__card">
                        <div>
                            <div class="flex-ai-c">
                                <img src="../assets/profile-3.png" width="44" height="44" alt="Foto de usuário relatando sua experiência na plataforma">
                    ...
                    <li class="testimonial__card">
                        <div>
                            <div class="flex-ai-c">
                                <img src="../assets/profile-4.png" width="44" height="44" alt="Foto de usuário relatando sua experiência na plataforma">
